      ...
      <section>
        <div className="flex flex-col gap-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">
            Learn how to build with InitPage.
          </h1>
  ...
  (req, res) => {
    res.json({ data: 'premium content' });
      ...
      <section className="border-t border-border pt-12">
        <h2 className="text-2xl font-bold text-foreground mb-6">What is InitPage?</h2>
        <div className="space-y-4 text-muted-foreground">
          <p>
            InitPage is an AI-native marketplace for creating payment-gated APIs and content using the HTTP 402 Payment Required status code.
      ...
      <footer className="mt-12 mb-12 flex flex-wrap justify-between gap-8 py-8 border-t border-border">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground">InitPage Docs</span>
          </div>
          <p className="text-xs text-muted-foreground">© 2025 InitPage. All rights reserved.</p>
        </div>
