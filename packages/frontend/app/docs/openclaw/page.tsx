      ...
      <section>
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            OpenClaw is a skill manifest specification that lets AI agents discover and use InitPage tools automatically. Configure your SKILL.md to make your agent marketplace-ready.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-6">
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              InitPage uses OpenClaw to declare its x402 marketplace skill, so any compatible agent framework can plug in and start buying/selling resources immediately.
            </p>
          </CardContent>
        </Card>
      </section>
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Here is the complete <code className="bg-muted px-1.5 py-0.5 rounded">SKILL.md</code> for InitPage&apos;s x402 skill:
            </p>
...
...`}</pre>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    ...
                    <td className="py-2">InitPage backend URL (e.g., <code className="bg-muted px-1 rounded">http://localhost:3001</code>)</td>
                  </tr>
                  <tr className="border-b border-border/50">
      ...
      <section className="flex flex-col gap-6">
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Add InitPage to your <code className="bg-muted px-1.5 py-0.5 rounded">claude_desktop_config.json</code>:
            </p>
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto text-sm">{`{
  "mcpServers": {
    "superpage": {
      ...
      "env": {
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Use the InitPage API directly from any agent framework:
            </p>
...
...`}</pre>
      ...
      <Card className="bg-primary/10 border-primary/20">
        ...
        <CardContent className="space-y-4">
          <p className="text-foreground text-sm">Explore more about building with InitPage:</p>
