      ...
      <main className="relative z-10 w-full max-w-2xl mx-auto px-6 sm:px-8 lg:px-10 pt-20 pb-12 flex flex-col items-center">
        ...
        <div className="w-full flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => {
              if (navigator.share) {
                navigator.share({
                  title: `${profile.displayName || profile.username} on InitPage`,
        ...
        <footer className="flex flex-col items-center gap-2 mt-auto pb-6">
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="text-sm font-bold">InitPage</span>
          </div>
          <p className="text-xs text-muted-foreground">Join {profile.username} on InitPage today</p>
        </footer>
      </main>
